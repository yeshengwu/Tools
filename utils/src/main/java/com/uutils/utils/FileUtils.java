...
public class FileUtils {
    ...
    public static String getDownloadFileType(String url) {
        ...
        if (name != null) {
            if (".php".equals(name) || ".asp".equals(name)
                    || ".jsp".equals(name) || ".html".equals(name)
                    || ".htm".equals(name)) {
                name = "";
            }
        }
    ...
    public static boolean copyFile(String file, String toFile) {
        boolean isOK = false;
        if (file == null || toFile == null || !createDir(getDirByFile(toFile)))
            return isOK;
        InputStream inputstream = null;
        OutputStream outputStream = null;
        try {
    ...
    public static boolean copyFromAsset(Context context, String FileName, String destName) {
        boolean isOK = false;
        if (FileName == null || destName == null|| !createDir(getDirByFile(destName)))
            return isOK;
        InputStream inputstream = null;
        OutputStream outputStream = null;
        try {
