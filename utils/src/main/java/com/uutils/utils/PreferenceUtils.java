...
public class PreferenceUtils {
    public static String sSharedPreferencesKey = null;

    private static SharedPreferences getSharedPreferences(Context context) {
        if (sSharedPreferencesKey == null) {
            sSharedPreferencesKey = "uutils_" + context.getPackageName() + ".prefs";
        }
        if (Build.VERSION.SDK_INT >= 22) {
            return context.getSharedPreferences(sSharedPreferencesKey,
