...
public class PackageUtils {
    /** com.android.vending */
    public static final String GOOGLE_PLAY_PKG
            = c + o + m + "." + a + n + d + r + o + i + d + "." + v + e + n + d + i + n + g;
    /** com.facebook.katana */
    public static final String FACEBOOK_PKG1 = "com.facebook.katana";
    /** com.facebook.lite */
    public static final String FACEBOOK_PKG2 = "com.facebook.lite";
    /** com.facebook.orca */
    public static final String FACEBOOK_PKG3 = "com.facebook.orca";
    public static final String REFERRER = r + e + f + e + r + r + "" + e + r;
    public static String ANDROID = "android";
    public static String PACKAGE = "package";
    public static String MARKET = "market";
    public static final String TYPE_APK = "application/vnd." + ANDROID + "."
            + PACKAGE + "-" + a + r + c + h + i + v + e;
    public static final String MARKET_DETAILS = MARKET + "://details?id=";

    /** com.android.vending.INSTALL_REFERRER */
    public static final String GOOGLE_PLAY_ACTION = GOOGLE_PLAY_PKG + "." + I + N + S + T + A + L + L + "_" + R + E + F + E + R + R + E + R;
    ...
    public static String getMarketUrl(String pkgName, String referrer) {
        if (TextUtils.isEmpty(referrer))
            return MARKET_DETAILS + "?id=" + pkgName;
    ...
    public static boolean checkPermission(Context context, String permission) {
        ...
        if (Manifest.permission.WRITE_SECURE_SETTINGS.equalsIgnoreCase(permission)
                || Manifest.permission.INSTALL_PACKAGES.equalsIgnoreCase(permission)
                || Manifest.permission.DELETE_PACKAGES.equalsIgnoreCase(permission)) {
     ...
     * @return
     */
    public static Drawable getAPKIcon(Context cxt, String apkPath)
     ...
     * @return
     */
    public static CharSequence getAPKLabel(Context cxt, String apkPath)
            throws PackageManager.NameNotFoundException {
        PackageManager pm = cxt.getPackageManager();
        PackageInfo pkgInfo = getAPKPackageInfo(cxt, apkPath);
        if (pkgInfo == null || pkgInfo.applicationInfo == null) {
    ...
    public static String getAppString(Context context, String pkgName, String key) {
        ...
        try {
            pkgContext = context.createPackageContext(pkgName,
    ...
    public static boolean hasService(Context context, String cls) {
        PackageManager pm = context.getPackageManager();
        try {
            pm.getServiceInfo(new ComponentName(context.getPackageName(), cls),
    ...
    public static boolean hasActivity(Context context, String cls) {
        PackageManager pm = context.getPackageManager();
        try {
            pm.getActivityInfo(new ComponentName(context.getPackageName(), cls),
    ...
    public static int checkSign(Context context, String apkFile) {
        ...
        try {
            ...
            if (TextUtils.equals(
                    old.signatures[0].toCharsString(),
                    apk.signatures[0].toCharsString())) {
                return 0;
            } else {
                return 1;
            }
     ...
     * @return
     */
    public static Intent findIntent(Context context, String keyName,
                                    boolean isSystem) {
